...
export const HW4 = () => {
  ...
  // [x] прописать типизацию, где необходимо
  // [x] починить все, что горит красным
  // [x] дописать функциональность (где указано комментариями)
  // [x] приложение должно компилироваться и запускаться в браузере
